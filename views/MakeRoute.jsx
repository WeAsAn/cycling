    ...
    <Layout user={user}>
      <div className="container-sm">
        ...
        <form action="post" name="newmap">
          <div className="mb-2">
            <label htmlFor="name" className="form-label">Название маршрута</label>
            <input type="text" className="form-control" id="name" placeholder="Лучший маршрут" name="name" />
          </div>
          <div className="mb-2">
            {/* <label htmlFor="city" className="form-label">Название маршрута</label>
            <input type="text" className="form-control" id="city" placeholder="Город мечты" name="city" /> */}
            <label htmlFor="city" className="form-label mt-20">Город</label>
            <input className="form-select" list="datalistOptions" id="city" placeholder="Самый-самый лучший город" />
          ...
          <div className="mb-3">
            <label htmlFor="info" className="form-label">Описание маршрута</label>
            <textarea className="form-control" id="info" rows="3" name="info" placeholder="Маршрут баги" />
          </div>
